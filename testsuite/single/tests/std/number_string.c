...
void do_tests()
{
    ...
    ASSERT_EQ( number_string( 1000, 0 ), "1000" ) ;
    ASSERT_EQ( number_string( 123456789, 0 ), "123456789" ) ;
    ...
    ASSERT_EQ( number_string( 1000.6, 0 ), "1000.600000" ) ;
    ASSERT_EQ( number_string( 123456789.123456, 0 ), "123456789.123456" ) ;
